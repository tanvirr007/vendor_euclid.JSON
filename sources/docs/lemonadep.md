...
- Now download firmware-Flasher 14.0.0.1901(EX01) [**HERE**](https://sourceforge.net/projects/euclidos-releases/files/Android-16/lemonadep/Utility)
...
- Download from [**HERE**](https://sourceforge.net/projects/euclidos-releases/files/Android-16/lemonadep/Utility) and extract recovery package then execute __recovery.bat__ or __recovery.sh__ as per your computer OS 
